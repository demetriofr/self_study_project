...
* **Имеет** доступ по механизму CRUD к назначенным им:
  - программам в модели "Программа" приложения "Материалы" (только просмотр).
...
модераторов.
  ...
  - "Материалы".
  - "Проверка знаний" (за исключением редактирования и удаление в модели "Проверка знаний"), 
...
- 
##### Валидаторы
- Создателем темы может быть только модератор или администратор.
...
### Описание задач
- [x] Реализовать функционал самообучения для обучающихся. 
- [x] Создать платформу, которая работает только с авторизованными пользователями. 
- [x] На платформе необходимо предусмотреть функционал программ, модулей и тем.
- [x] Управление всеми сущностями реализовать через стандартный Django admin.
- [x] Реализовать Rest API.
- [x] Использовать фреймворк Django. 
                                                                                                                                     
**Критерии успешного выполнения данной работы:**                                                                                                               
- [x] Настроена CORS.
...
- [x] Проект покрыт тестами как минимум на 80%.
