...
##### Валидаторы
- Дата рождения должна меньшей или равной дате полученной вычитанием 18 лет от даты занесения физлица, если класс 
условий труда не равен 1 или 2.
...
##### Валидаторы
- Дата приёма должна не должна быть больше даты внесение данных.
...
* **Имеет** доступ по механизму CRUD к моделям в приложениях:
  - "Организация" (за исключением удаления "Физлица") которые создал сам, открыты администратором для группы 
модераторов.
...
* **Имеет** доступ по механизму CRUD к моделям в приложениях:
  - "Рабочие места". 
  - "Организация" (кроме модели "Физлица" для которой возможен только просмотр). 
  - "Планирование". 
